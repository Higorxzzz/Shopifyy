...
export default function Page() {
  ...
  const pageStructuredData = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    "@id": "https://theskitbit.com/catalogo",
    name: "Catálogo | Skitbit | 3D Animation Made Simple, Reliable & Scalable",
    description:
    ...
    url: "https://theskitbit.com/catalogo",
    mainEntity: {
      "@type": "Organization",
      name: "Skitbit",
