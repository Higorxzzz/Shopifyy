          ...
          <div className="mb-12 w-full max-w-5xl">
            ...
            <div className="hidden sm:grid gap-4 sm:grid-cols-3 lg:grid-cols-5">
              ...
              <div className="col-span-2 flex items-center justify-center rounded-2xl liquid-glass px-8 py-6">
                <span className="text-xl font-light tracking-[0.2em] text-neutral-100">NORDSTROM</span>
              </div>
              <div className="flex items-center justify-center rounded-2xl liquid-glass p-6">
                <div className="flex h-8 w-8 items-center justify-center">
                  <div className="h-6 w-6 rounded-full bg-gradient-to-br from-neutral-300 to-neutral-500"></div>
                </div>
              </div>
              <div className="col-span-2 flex items-center justify-center rounded-2xl liquid-glass px-8 py-6">
                <span className="text-xl font-light tracking-[0.3em] text-neutral-100">TESLA</span>
              </div>

              {/* Row 2 */}
              <div className="flex items-center justify-center rounded-2xl liquid-glass p-6">
                <div className="text-2xl text-neutral-100">🍎</div>
              </div>
              <div className="flex items-center justify-center rounded-2xl liquid-glass px-6 py-6">
                <div className="rounded-full border-2 border-neutral-300 px-4 py-1">
                  <span className="text-sm font-serif italic text-neutral-100">Ford</span>
                </div>
              </div>
              <div className="flex items-center justify-center rounded-2xl liquid-glass px-6 py-6">
                <span className="text-lg font-bold tracking-wider text-neutral-100">GAP</span>
              </div>
              <div className="flex items-center justify-center rounded-2xl liquid-glass px-6 py-6">
                <span className="text-lg font-light tracking-wide text-neutral-100">LACOSTE</span>
              </div>
              <div className="flex items-center justify-center rounded-2xl liquid-glass px-6 py-6">
                <span className="text-xl font-bold text-neutral-100">ca</span>
              </div>
              ...
              <div className="flex items-center justify-center rounded-2xl liquid-glass p-6">
                <div className="grid grid-cols-2 gap-1">
                  {[...Array(4)].map((_, i) => (
                    <div key={i} className="h-2 w-2 rounded-sm bg-neutral-300"></div>
                  ))}
                </div>
              </div>
              <div className="col-span-2 flex items-center justify-center rounded-2xl liquid-glass px-8 py-6">
                <div className="flex items-center gap-2">
                  <div className="h-6 w-6 rounded-full border-2 border-neutral-300 flex items-center justify-center">
                    <div className="text-xs text-neutral-100">★</div>
                  </div>
                  <span className="text-lg font-light text-neutral-100">Mercedes-Benz</span>
                </div>
              </div>
              <div className="flex items-center justify-center rounded-2xl liquid-glass p-6">
                <div className="text-2xl text-neutral-100">🍎</div>
            ...
            <div className="flex flex-col gap-4 sm:hidden">
              <div className="flex items-center justify-center rounded-2xl liquid-glass px-8 py-8">
                <span className="text-2xl font-light tracking-[0.2em] text-neutral-100">NORDSTROM</span>
              </div>
              <div className="flex items-center justify-center rounded-2xl liquid-glass p-8">
                <div className="flex h-10 w-10 items-center justify-center">
                  <div className="h-8 w-8 rounded-full bg-gradient-to-br from-neutral-300 to-neutral-500"></div>
                </div>
              </div>
              <div className="flex items-center justify-center rounded-2xl liquid-glass px-8 py-8">
                <span className="text-2xl font-light tracking-[0.3em] text-neutral-100">TESLA</span>
              </div>
              <div className="flex items-center justify-center rounded-2xl liquid-glass p-8">
                <div className="grid grid-cols-2 gap-2">
                  {[...Array(4)].map((_, i) => (
                    <div key={i} className="h-3 w-3 rounded-sm bg-neutral-300"></div>
                  ))}
                </div>
              </div>
            </div>
