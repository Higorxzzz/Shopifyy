...
export function LoginForm() {
  ...
  return (
    <Card className="w-full max-w-md liquid-glass border-white/20">
      <CardHeader className="space-y-1 text-center">
        <CardTitle className="text-2xl font-bold text-white">Área de Membros</CardTitle>
        <CardDescription className="text-gray-300">Acesse sua conta para ver as lojas exclusivas</CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button
            type="submit"
            className="w-full bg-[#9ae600] hover:bg-[#8bd500] text-black font-semibold"
            disabled={isLoading}
          >
