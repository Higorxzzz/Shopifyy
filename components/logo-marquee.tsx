...
export function LogoMarquee() {
  ...
  const logos = [
    { name: "Intel", content: "intel", color: "text-neutral-100" }, // Improved contrast
    { name: "MongoDB", content: "🟢", color: "text-green-500" },
    { name: "Skitbit", content: "image", color: "text-neutral-100", image: "/images/skitbit-subtle-logo.png" }, // Improved contrast
    { name: "VK", content: "VK", color: "text-white", bg: "bg-blue-500" },
    { name: "TechCrunch", content: "TC", color: "text-neutral-100" }, // Improved contrast
    { name: "MailChimp", content: "🐵", color: "text-yellow-500" },
    { name: "ESJ", content: "image", color: "text-neutral-100", image: "/images/esj-subtle-logo.png" }, // Improved contrast
    { name: "Kickstarter", content: "K", color: "text-white", bg: "bg-green-500" },
  ]

  const secondRowLogos = [
    { name: "StumbleUpon", content: "🔴", color: "text-red-500" },
    { name: "Microsoft", content: "⊞", color: "text-neutral-200" }, // Improved contrast
    { name: "CleanMyMac", content: "🌈", color: "text-purple-400" },
    { name: "Google", content: "G", color: "text-neutral-100" }, // Improved contrast for Google G
    { name: "Behance", content: "Be", color: "text-white", bg: "bg-blue-500" },
    { name: "Apple", content: "🍎", color: "text-neutral-100" }, // Improved contrast for Apple emoji
    { name: "TransferWise", content: "✓", color: "text-white", bg: "bg-green-500" },
    { name: "Medium", content: "M", color: "text-neutral-100" }, // Improved contrast
  ]
