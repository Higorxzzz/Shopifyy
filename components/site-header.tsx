...
import { Menu, Home, Play, Tag, Users } from "lucide-react"

export function SiteHeader() {
  const links = [
    { href: "/", label: "Home", icon: Home },
    { href: "#explicacao", label: "Explicação", icon: Play },
    { href: "#pricing", label: "Preços", icon: Tag },
    { href: "/dashboard", label: "Área de Membros", icon: Users },
  ]
          ...
          <div className="md:hidden">
            <Sheet>
              ...
              <SheetContent side="right" className="liquid-glass border-gray-800 p-0 w-64 flex flex-col">
                ...
                {/* Nav Links */}
                <nav className="flex flex-col gap-1 mt-2 text-gray-100">
                  {links.map((l) => (
                    <Link
                      key={l.href}
                      href={l.href}
